...
############################---------------The script's name is arapk. -------------------------------##################################################
############################---------------Its only purpose is to automate the decompiling, recompiling , keystore generation and signing the apk. ####
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
class SignApp:
	...
	def generateKeystore(self):
		...
		try:
			...
			print "Sorry. There seem to be some problem with rapk"
			print e
...
if __name__ == "__main__":
    ...
    try:
        ...
        print "python arapk.py -g <Keystore_name>"
        print "python arapk.py -n <keystore_name> -s <path_to_apk>"
        print "python arapk.py -d <path_to_apk_decompile>"
        print "python arapk.py -r <path_to_folder_to_recompile>"
        sys.exit(2)
    #print opts
    obj = SignApp()
    for opt, arg in opts:
